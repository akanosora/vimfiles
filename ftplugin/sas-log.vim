...
" Key mappings
nnoremap <buffer> <silent> ]] :call <SID>JumpSASCode('n', '\v%$\|^(WARNING\|ERROR)>', 'W')<CR>
onoremap <buffer> <silent> ]] :call <SID>JumpSASCode('o', '\v%$\|^(WARNING\|ERROR)>', 'W')<CR>
xnoremap <buffer> <silent> ]] :call <SID>JumpSASCode('x', '\v%$\|^(WARNING\|ERROR)>', 'W')<CR>

nnoremap <buffer> <silent> [[ :call <SID>JumpSASCode('n', '\v%^\|^(WARNING\|ERROR)>', 'Wb')<CR>
onoremap <buffer> <silent> [[ :call <SID>JumpSASCode('o', '\v%^\|^(WARNING\|ERROR)>', 'Wb')<CR>
xnoremap <buffer> <silent> [[ :call <SID>JumpSASCode('x', '\v%^\|^(WARNING\|ERROR)>', 'Wb')<CR>

...
syn keyword sasReserved _all_ _automatic_ _char_ _character_ _data_ _infile_ _label_ _last_ _n_ _null_ _num_ _numeric_ _temporary_ _user_ _webout_
" Strings
...
syn region sasIML matchgroup=sasSectionKeyword start='\v%(^|;)\s*\zsproc\s+iml>' end='\v%(^|;)\s*%(quit|endsas)>'me=s-1 fold contains=@sasBasicSyntax,sasIMLFunction,sasIMLControl,sasIMLStatement

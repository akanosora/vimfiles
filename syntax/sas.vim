...
syn match sasDataStepFunctionHead '\v%(input|put)\(' display contained contains=sasDataStepFunctionName,sasDataStepCallRoutineName nextgroup=sasDataStepFunctionFormatContext
syn region sasDataStepFunctionFormatContext start='.' end=')'me=s-1 contained contains=@sasBasicSyntax,sasDataStepFunction,sasFormat
